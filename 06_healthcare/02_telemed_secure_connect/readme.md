...
````carousel
![Interfaz Doctor - Historial clínico protegido y controles de sesión](./screenshots/intefaz_dr.png)
<!-- slide -->
![Interfaz Paciente - Citas próximas y historial personal](./screenshots/interfaz_paciente.png)
````
